      ...
      <div className=" h-[5rem] flex items-center justify-between px-4 md:max-w-[90vw] mx-auto">
        ...
        <div className="flex items-center">
          ...
          <div className="text-white font-bold">
            <p className="text-[21px] pl-2">HCL Tech</p>
          </div>
        </div>
        ...
        <div className="">
          <ul className="text-white font-bold flex items-center gap-4 cursor-pointer">
            <a href="https://hcltech.herokuapp.com/index.php">Home</a>
            <a href="https://hcltech.herokuapp.com/index.php?quanly=danhmuc">Sản phẩm</a>
